...
const convertPatientInfoToRedCapRow = (patientSearch: FullSearchParameters) => {
  ...
  return {
    ...
    pre_cancer_subtype___1: pre_cancerSubtype,
    histology___1: cancerSubtype,
    pre_stage: pre_stage,
    stage: stage,
    ...
    kps: karnofskyScore,
    pre_metastasis___1: pre_metastasis,
    sites_of_mets___1: metastasis,
