...
export const MCODE_CLINICAL_DISTANT_METASTASIS =MCODE_STRUCTURE_DEFINITION + 'tnm-clinical-distant-metastases-category-cM0';
export const MCODE_CANCER_RELATED_SURGICAL_PROCEDURE =MCODE_STRUCTURE_DEFINITION+'mcode-cancer-related-surgical-procedure';
export const MCODE_CANCER_RELATED_MEDICATION_STATEMENT=MCODE_STRUCTURE_DEFINITION+'mcode-cancer-related-medication-statement';
export const MCODE_CANCER_RELATED_RADIATION_PROCEDURE=MCODE_STRUCTURE_DEFINITION+'mcode-cancer-related-radiation-procedure';
