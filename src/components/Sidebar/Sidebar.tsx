...
const Sidebar = ({ patient, disabled, savedStudies, filterOptions, query, setUserId }: SidebarProps): ReactElement => {
  ...
  const defaultSearchValues = {
    ...
    primaryTumorStage: query.primaryTumorStage ? JSON.parse(query.primaryTumorStage as string) : null,
    nodalDiseaseStage: query.nodalDiseaseStage ? JSON.parse(query.nodalDiseaseStage as string) : null,
    metastasesStage: query.metastasesStage ? JSON.parse(query.metastasesStage as string) : null,
