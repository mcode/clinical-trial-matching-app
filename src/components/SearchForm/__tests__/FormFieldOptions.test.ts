...
jest.mock('@/assets/optimizedPatientDataElements/metastasesStages.json', () => []);
jest.mock('@/assets/optimizedPatientDataElements/nodalDiseaseStages.json', () => []);
jest.mock('@/assets/optimizedPatientDataElements/primaryTumorStages.json', () => []);
